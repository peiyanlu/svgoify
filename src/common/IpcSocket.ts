 ...
 * @public
 */
export type IpcListener = (evt: Electron.Event, ...args: any[]) => void;
...
export interface IpcSocket {
   ...
   * @param channel The name of the channel for the message. Must begin with the [[ipcChannel]] prefix.
   ...
   * @param channel The name of the channel for the messages. Must begin with the [[ipcChannel]] prefix.
...
export interface IpcSocketFrontend extends IpcSocket {
   ...
   * @param channel The name of the channel for the method.  Must begin with the [[ipcChannel]] prefix.
...
export interface IpcSocketBackend extends IpcSocket {
   ...
   * @param channel The name of the channel for this handler. Must begin with the [[ipcChannel]] prefix.
