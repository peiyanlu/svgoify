...
export class ProcessDetector {
  ...
  public static get isElectronAppFrontend() {
    return typeof navigator === 'object' && navigator.userAgent.toLowerCase()
      .indexOf('electron') >= 0
  }
  ...
  public static get isChromium() {
    return (this.isBrowserProcess && window.navigator.userAgent.indexOf('Chrome') > -1 && window.navigator.userAgent.indexOf(
      'OP') === -1) || this.isElectronAppFrontend
  }
  
  /** Is this process the frontend of an mobile application?
   * @note this indicates that this is a browser process started by an mobile application.
